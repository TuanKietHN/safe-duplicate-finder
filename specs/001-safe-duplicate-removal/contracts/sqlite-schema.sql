...
CREATE TABLE scan_sessions (
    ...
    control_request TEXT NOT NULL DEFAULT 'none' CHECK (
        control_request IN ('none', 'pause', 'resume', 'cancel')
    ),
...
CREATE TABLE quarantine_entries (
    ...
    restored_at TEXT,
    permanent_delete_state TEXT NOT NULL DEFAULT 'active'
        CHECK (permanent_delete_state IN ('active', 'deleting', 'deleted', 'failed')),
    permanent_delete_batch_id TEXT,
    deleted_at TEXT,
