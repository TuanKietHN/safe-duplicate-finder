...
**Tests**: Tests are MANDATORY for this project. Safety-relevant tests MUST be written and observed
failing before implementation, including property, transaction, restore, crash-recovery, and fault-
injection coverage where applicable.
...
- [ ] T010 [P] Create data-loss threat model and safety-invariant test harness
- [ ] T011 [P] Create deterministic fault-injection framework for filesystem and database boundaries
